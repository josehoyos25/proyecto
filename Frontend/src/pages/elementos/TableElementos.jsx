...
import ActualizarElemento from '../../components/modals_elementos/ActualizarElemento';
import EliminarElemento from '../../components/modals_elementos/EliminarElemento';
        ...
        <TableBody>
          {paginatedData.map(item => (
            <TableRow key={item.id_elemento}>
              ...
              <ActualizarElemento elemento={item} fetchData={fetchData}/>
              <EliminarElemento elemento={item} fetchData={fetchData}/>
